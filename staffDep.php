...
<?php   
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a data-toggle='modal' data-id='' href='#Initialisation2' class='open-Initial2'><i class="fa fa-minus"></i>View Dependants</a></li>
                </ul>
              </li>
		...
		<div id="page-wrapper"  >
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">Staff Dependants</h4>
        ...
        <thead>
            <tr>
                ...
                <th>MALE DEPENDANTS</th> 
                <th>FEMALE DEPENDANTS</th>  
                <th>OLD DEPENDANT AGE</th>  
                <th>YOUNG DEPENDANT AGE</th>                                       
                <th>HOME ADDRESS</th>
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM StaffDep ";
			       $retrieve = mysqli_query($db,$sqlmember);
				                    $count=0;
                     while($found = mysqli_fetch_array($retrieve))
	                 {
                       $EmployeeNo=$found['EmployeeNo'];$EmployeeName=$found['EmployeeName'];$FDepNo=$found['FDepNo'];$MDepNo=$found['MDepNo'];
                       $id=$found['id'];$AgeOldDep=$found['AgeOldDep'];$AgeYoungDep=$found['AgeYoungDep']; $Address=$found['Address']; 
			                $count=$count+1; 
