...
/// Start of Creating Tables SQL Scripts \\\		                       		    
	...
	$db->query($table4); 
        ...
        $table9= "CREATE TABLE IF NOT EXISTS pensions (emp_no varchar(30) NOT NULL,
	...
	$db->query($table8); 
        ...
        $table10="CREATE TABLE IF NOT EXISTS staff_ben (emp_id int(11) NOT NULL auto_increment,
        ...
        $table11="CREATE TABLE IF NOT EXISTS StaffDep (
            id int(11) NOT NULL auto_increment,
