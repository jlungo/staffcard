...
<?php if (isset($_SESSION['deductionexist'])) { ?>
	<script type="text/javascript">
		$(document).ready(function() {
			swal({
				title: "Successful!",
				text: "Deduction Already exist.",
				type: "warning"
			});
		});
	</script>
			...
			<form action="upload.php" method="POST">
				...
				<div class="modal-body">
					...
					<div class="input-group" style="margin-bottom:10px">
						...
						<input id="deduction_percentage" type="number" class="form-control" name="deduction_percentage">
					</div>
				</div>
				<div class="modal-footer">
			...
			<div class="modal-body">
				<center>
					...
					<form method="post" action="upload.php" enctype='multipart/form-data'>
						...
						<p><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp; &nbsp;&nbsp;Staff
								ID:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mid" id='oldpass'></span></p>
			...
			<div class="modal-body">
				<center>
					<form method="post" action="upload.php" enctype='multipart/form-data' style="width: 98%;">
						...
						<p><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp; &nbsp;&nbsp;Staff
								ID:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mpassword"></span></p>
						Add profile picture:<input name='filed' type='file' id='filed'>
				...
				<div class="modal-body">
					<center>
						...
						<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Active
								Year:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="orgyear"></span></p>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a data-toggle='modal' data-id='' href='#Initialisation2' class='open-Initial2'><i class="fa fa-minus"></i>Edit System Info</a>
									</li>
								</ul>
							</li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li>
										<a href='deductions_staff.php' class='open-Initial2'><i class="fa fa-minus"></i>Staff Information</a>
									</li>
								</ul>
							</li>
							<li class="treeview">
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								<li>
									<a data-toggle='modal' data-id='<?php echo $id; ?>' href='#Updatepicture' class='open-Updatepicture'><i class="fa fa-user"></i>Change profile
										picture</a>
								</li>
										...
										<div id="edit_deduction_<?php echo $id; ?>" class="modal fade" role="dialog">
											<div class="modal-dialog">
												...
												<div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
													...
													<form action="upload.php" method="POST">
														<input type="hidden" name="deduction_id" value='<?php echo $id; ?>' />
														<div class="modal-body">
															<div class="input-group" style="margin-bottom:10px">
																<span class="input-group-addon">Deduction Name</span>
																<input type="text" class="form-control" value="<?php echo $title; ?>" name="deduction_namex">
															</div>
															<div class="input-group" style="margin-bottom:10px">
																<span class="input-group-addon">Description</span>
																<textarea class="form-control" name="deduction_descriptionx">
																<?php echo $description; ?>
																</textarea>
															</div>
															<div class="input-group" style="margin-bottom:10px">
																<span class="input-group-addon">Amount</span>
																<input type="number" class="form-control" value="<?php echo $amount; ?>" name="deduction_amountx">
															</div>
															<div class="input-group" style="margin-bottom:10px">
																<span class="input-group-addon">Percentage</span>
																<input type="number" class="form-control" value="<?php echo $percentage; ?>" name="deduction_percentagex">
															</div>
														</div>
														<div class="modal-footer">
															<input type="submit" class="btn btn-success" value="Submit" name="edit_deduction">
														</div>
													</form>
												</div>
											</div>
