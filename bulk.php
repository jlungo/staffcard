...
<div id="Updatepanel" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      -->
                ...
                <a id='Enumeration' href="#" style="width:100%;font-size: 15px;"
                    class="Open-Enumeration btn btn-success">
                    <span class="glyphicon glyphicon-map-marker" style="color:#00ACED;font-size: 28px;"></span>Update
                    Actual Enumeration by Selecting Actual Tax Payer</a>


                <a id='groupss' href="#" style="width:100%;font-size: 15px;" class="Open-groups btn btn-success">
                    <span class="glyphicon glyphicon-magnet" style="font-size: 28px;"></span>Update Enumeration Data
                    Based on Group</a>
        ...
        <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
            ...
            <div class="modal-body">
                <center>
                    ...
                    <a id='Taxreceipt' href="#" style="width:90%;font-size: 24px;"
                        class="Open-Taxreceipt btn btn-success">CLICK TO PROCEED TO TAX RECEIPTS</a>
                </center>
            </div>
            <div class="modal-footer">
            </div>
        ...
        <div id="page-wrapper">
            ...
            <div class="charts">
                <div class="mid-content-top charts-grids">
                    ...
                    <div class="alert alert-success">
                        <i class="fa fa-info-circle"></i>&nbsp;Ensure that the file upload is in CSV Format Otherwise it
                        will not save
                    </div>
                    <!--//sreen-gallery-cursual---->
                </div>
            ...
            <div class="charts">
                <div class="mid-content-top charts-grids" style="background-color:#00ACED">
                    <div class="middle-content">
                        ...
                        <div class="container">
                            <ol>
                                <li>Download the sample file format below on the mail icon or on top of the to the right
                                    corner of this page on a downoad icon</li>
                                <li>Fill the employee details in the columns of the file</li>
                                <li>Save the file as CSV not as xls </li>
                                <li>Upload the file</li>
                            </ol>
                        </div>
                        SAMPLE FORMAT&nbsp;<a href='bulk.php?ids=1'><i class="fa fa-envelope"></i></a>&nbsp;Note:The web
                        as file type will only be noted on excel files download from this application
            ...
            <div class="charts">
                <div class="mid-content-top charts-grids">
                    ...
                    <form method="post" action="upload.php" enctype='multipart/form-data'>
                        <p style="margin-bottom:10px;">
                            <input id="datepicker-starting-view" type="text" class="form-control"
                                data-zdp_readonly_element="false" placeholder="Select Submission Date" name="sbd"
                                style='width:255px;'>
                        </p>
