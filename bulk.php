	...
	<div class="modal-dialog">
      ...
      -->
				...
				<a id='Enumeration' href="#" style="width:100%;font-size: 15px;" class="Open-Enumeration btn btn-success">
					<span class="glyphicon glyphicon-map-marker" style="color:#00ACED;font-size: 28px;"></span>Update Actual Enumeration by Selecting Actual
					Tax Payer</a>
			...
			<div class="charts">
				<div class="mid-content-top charts-grids">
					...
					<div class="alert alert-success">
						<i class="fa fa-info-circle"></i>&nbsp;Ensure that the file upload is in CSV Format
			...
			<div class="charts">
				<div class="mid-content-top charts-grids" style="background-color:#00ACED">
					<div class="middle-content">
						...
						<div class="container">
							<ol>
								<li>Download the sample file format below on the mail icon or on top of the to the
									right corner of this page on a downoad icon</li>
								<li>Fill the employee details in the columns of the file</li>
								<li>Save the file as CSV not as xls </li>
								<li>Upload the file</li>
							</ol>
						</div>
						SAMPLE FORMAT&nbsp;<a href='bulk.php?ids=1'><i class="fa fa-envelope"></i></a>&nbsp;Note:The
						web as file type will only be noted on excel files download from this application
