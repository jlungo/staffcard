      ...
      <div class="modal-body">
        <center>
          ...
          <form method="post" action="upload.php" enctype='multipart/form-data'>
            ...
            <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Emp_No:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mfname" id='oldname'></span></p>
            <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Emp_Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="msname" id='ss'></span></p>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a data-toggle='modal' data-id='' href="admin.php" class='open-Initial2'><i class="fa fa-minus"></i>VIEW OPRAS REPORT</a></li>
                </ul>
              </li>
            ...
            <div class="modal-body">
              <center>
                <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;Emp_Name:<label style="color: red;font-size:20px;">*</label>
                    <input style="width:270px;" type="text" placeholder="Enter Emp_Name" name="Emp_Name" input onkeypress="return /[a-z]/i.test(event.key)" value="<?php if (isset($phone)) {
                                                                                                                                                                      echo $phone;
                                                                                                                                                                    } ?>" required></span></p>
              ...
              <table id="example" class="table table-striped " style="width:100%">
                <thead>
                  <tr>
                    ...
                    <th>Emp_Name</th>
                    <th>Objective</th>
                    <th>Apraisee_score</th>
                    <th>Supervisor_score</th>
                ...
                <tbody>
                  <?php $sqlmember = "SELECT * FROM opras ";
                  $retrieve = mysqli_query($db, $sqlmember);
                  $count = 0;
                  while ($found = mysqli_fetch_array($retrieve)) {
                    $title = $found['Emp_Name'];
                    $firstname = $found['Objective'];
                    $surname = $found['Apraisee_score'];
                    $rank = $found['Supervisor_score'];
                    $id = $found['Emp_No'];
                    $dept = $found['Performance_score'];
                    $contact = $found['Recommendations'];
                    $count = $count + 1;
                    $pass = $found['Emp_No'];
