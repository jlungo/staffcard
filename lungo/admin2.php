        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM opras ";
			       $retrieve = mysqli_query($db,$sqlmember);
	                 ...
	                 {
                       $title=$found['Emp_Name'];$firstname=$found['Objective'];$surname=$found['Apraisee_score'];$rank=$found['Supervisor_score'];
                       $id=$found['Emp_No'];$dept=$found['Performance_score'];$contact=$found['Recommendations'];
			                $count=$count+1;  $pass=$found['Emp_No'];
