	...
	if(isset($_POST['addDependant']))
     {
     	 if($_POST['EmployeeNo']!=''&&$_POST['EmployeeName']!=''&&$_POST['FDepNo']!=''&&$_POST['MDepNo']!=''&&$_POST['AgeOldDep']!=''&&$_POST['AgeYoungDep']!='' &&$_POST['Address']!='')
   		...
   		$mfname = mysqli_real_escape_string($db,$_POST['EmployeeNo']);
		$msname = mysqli_real_escape_string($db,$_POST['EmployeeName']);		
	  	$memail=mysqli_real_escape_string($db,$_POST['FDepNo']);
	    $mphone =mysqli_real_escape_string($db,$_POST['MDepNo']);
		$minstititution = mysqli_real_escape_string($db,$_POST['AgeOldDep']);
		$mpassword = mysqli_real_escape_string($db,$_POST['AgeYoungDep']);
		$pagex = mysqli_real_escape_string($db,$_POST['page']);
