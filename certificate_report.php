...
<script type="text/javascript">
            $(document).on("click", ".open-Delete-certificate", function () {
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
        ...
        <h4 class="modal-title" style="font-weight: bold;color: #F0F0F0"><center>
      	...
      	<form method="post" action="insert_certificate.php" enctype='multipart/form-data'>
      ...
      <center> 
            ...
            <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Attachment Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="file" name="attachment_name" id="attachment_name" accept=".pdf"></span></p>
      </center>
      </div>
      <div class="modal-footer">
...
<?php
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
               ...
               <li class="treeview">
                <a href="#">
                <i class="fa fa-cog"></i>
                <span>Certificates Information</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li><a data-toggle='modal' data-id='' href='#add_certificate' class='open-Initial'><i class="fa fa-plus"></i>Add Certificate</a></li>
                  <li><a href='certificate_report.php' class='open-Initial2'><i class="fa fa-minus"></i>Certificate Report</a></li>
                </ul>
              </li>
		...
		<div id="page-wrapper"  >
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">certificates report</h4>
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM certificates ";
			      ...
			      echo"<tr>    
                    ...
                    <td>
                    <a data-toggle='modal' class='open-Passwords btn  btn-info' title='edit certificate' href='#Passwords'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
                    </td>
			              <td>
			                <a data-id='$emp_no'   class='open-Delete-certificate btn  btn-danger' title='delete certificate' ><span class='glyphicon glyphicon-trash' style='color:white;'></span></a>
			              </td>			 
                </tr>"; 
