...
<?php if (isset($_SESSION['dependantAdded'])) { ?>
  <script type="text/javascript">
    $(document).ready(function() {
      swal({
        title: "Successful!",
        text: "Staff Dependant added successfully!!.",
        type: "success"
      });
    });
  </script>
          ...
          <div class="mid-content-top charts-grids">
            <div class="middle-content">
              ...
              <table id="example" class="display nowrap" style="width:100%">
                <!-- beggining of the headings of the table to display spouse resulsts -->
                <thead>
                  <tr>
                    <th>ID</th>
                ...
                <!-- end of the headings of the table to display spouse resulsts -->
                ...
                <tbody>
                  ...
                  while ($found = mysqli_fetch_array($retrieve)) {
                    $EmployeeNo = $found['Emp_No'];
                    $EmployeeName = $found['Emp_Name'];
                    $MaritalStatus = $found['Marital_status'];
                    $Sex = $found['Sex'];
                    $id = $found['id'];
                    $DateMarried = $found['Date_married'];
                    $SpouseName = $found['Spouse_name'];
                    $DistrictMarried = $found['District_married'];
                    $count = $count + 1;
